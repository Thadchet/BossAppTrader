...
function FlatListCrypto({
            ...
            >
              ...
              >
                <Image
                  ...
                  source={
                    MAPPINGLOGO[nameCoin].image == "undefine"
                      ? require("../assets/images/logo-crypto/ethereum-eth-logo.png")
                      : MAPPINGLOGO[nameCoin].image
                  }
                />
                <View
                  style={[
  ...
  return (
    <FlatList
      ...
      extraData={sortCryptoBy(
        "percentChange",
        isMostGainEnable ? "desc" : "inc"
      )}
